...
Afterwards we **Think**. We do it by creating and solving a planning problem using PDDL. The planning problem solution is a plan to move the blocks from the given Initial State to a Goal State chosen by the user. 
